  ...
  <body>
    ...
    <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
      ...
      <ul class="nav menu">
        ...
        <li><a href="logout.php"><svg class="glyph stroked male-user"><use xlink:href="#stroked-male-user"></use></svg> Đăng xuất</a></li>
      </ul>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
      ...
      if (isset($_GET["page_layout"])) {
        ...
        case 'danhsachdm':
          require_once "./danhsachdm.php";
          break;
        case 'danhsachsp':
          require_once "./danhsachsp.php";
          break;
        case 'suadm':
          require_once "./suadm.php";
          break;
        case 'suasp':
          require_once "./suasp.php";
          break;
        case 'themdm':
          require_once "./themdm.php";
          break;
        case 'themsp':
